            ...
            <div
                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    <div class="btn-group me-2">
                        <a href="@yield("add_new_url")" class="btn btn-sm btn-outline-danger">@yield("url_name")</a>
                    </div>
...
<script type="text/javascript" src="{{asset("build/assets/app-e1d470c3.js")}}"></script>
...
<!-- Burası modal a veri göndermek için ama data-toogle ile yaptık şuan gerek kalmadı
